...
docker exec -ti $DOCKER_CONTAINER_ID apt-get -y install git cmake build-essential cmake gettext wx-common dialog libwxgtk3.0-gtk3-dev libbz2-dev libcurl4-openssl-dev libexpat1-dev libcairo2-dev libarchive-dev liblzma-dev libexif-dev lsb-release 
...
#    'mkdir source_top/build; cd source_top/build; cmake ..; make -j2 ; make package;'
...
UNSTABLE_REPO=${CLOUDSMITH_UNSTABLE_REPO}
STABLE_REPO=${CLOUDSMITH_STABLE_REPO}
